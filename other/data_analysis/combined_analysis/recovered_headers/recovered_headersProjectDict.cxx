...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CentroidData*)
   {
      ...
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CentroidData >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("CentroidData", ::CentroidData::Class_Version(), "CentroidData.h", 16,
                  typeid(::CentroidData), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::CentroidData::Dictionary, isa_proxy, 4,
                  sizeof(::CentroidData) );
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TrackData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TrackData", ::TrackData::Class_Version(), "TrackData.h", 16,
...
atomic_TClass_ptr CentroidData::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *CentroidData::Class_Name()
{
   return "CentroidData";
}

//______________________________________________________________________________
const char *CentroidData::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CentroidData*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int CentroidData::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CentroidData*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *CentroidData::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CentroidData*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *CentroidData::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CentroidData*)nullptr)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void CentroidData::Streamer(TBuffer &R__b)
{
   // Stream an object of class CentroidData.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CentroidData::Class(),this);
   } else {
      R__b.WriteClassBuffer(CentroidData::Class(),this);
   }
}
...
namespace ROOT {
   ...
   int RecordReadRules_recovered_headersProjectDict() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_recovered_headersProjectDict) = RecordReadRules_recovered_headersProjectDict();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_recovered_headersProjectDict));
} // namespace ROOT
namespace {
...
"/usr/share/root/cling/plugins/include",
"/usr/include/root",
